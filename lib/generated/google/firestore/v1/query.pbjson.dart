...
const StructuredAggregationQuery_Aggregation$json = {
  ...
  '3': [StructuredAggregationQuery_Aggregation_Count$json],
  '8': [
    {'1': 'operator'},
  ],
};
...
final $typed_data.Uint8List structuredAggregationQueryDescriptor = $convert.base64Decode(
    ...
    'FnZ3JlZ2F0aW9uUXVlcnkuQWdncmVnYXRpb25CA+BBAVIMYWdncmVnYXRpb25zGs8BCgtBZ2dy'
    'ZWdhdGlvbhJZCgVjb3VudBgBIAEoCzJBLmdvb2dsZS5maXJlc3RvcmUudjEuU3RydWN0dXJlZE'
    'FnZ3JlZ2F0aW9uUXVlcnkuQWdncmVnYXRpb24uQ291bnRIAFIFY291bnQSGQoFYWxpYXMYByAB'
    'KAlCA+BBAVIFYWxpYXMaPgoFQ291bnQSNQoFdXBfdG8YASABKAsyGy5nb29nbGUucHJvdG9idW'
    'YuSW50NjRWYWx1ZUID4EEBUgR1cFRvQgoKCG9wZXJhdG9yQgwKCnF1ZXJ5X3R5cGU=');
